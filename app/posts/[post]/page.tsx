  ...
  return (
    <div className="fcm w-full gap-8">
      <div className="frm gap-10 w-full h-fit">
        <div className="w-1/3">
          <Image
            src={data.img || "https://images.pexels.com/photos/753695/pexels-photo-753695.jpeg"}
            width={1440}
            height={1440}
        ...
        <div className="w-2/3 flex-col gap-8 justify-start">
          <div className="frm w-full">
            ...
            <div className="frm gap-2">
              ...
              <span className="text-2xl mr-6">|</span>
              <span className="text-xl">{data.createAt.substring(0,10).split('-').reverse().join('-')}</span>
            </div>
          </div>
      ...
      <div className="flex w-full gap-8">
        ...
        <div className="flex flex-col gap-6 text-xl text-justify justify-start p-4 w-2/3" dangerouslySetInnerHTML={{__html: data.desc}}/>
